...
impl From<AriesVcxErrorKind> for LibvcxErrorKind {
    fn from(kind: AriesVcxErrorKind) -> Self {
        match kind {
            ...
            AriesVcxErrorKind::AskarBackend => LibvcxErrorKind::AskarBackend,
            AriesVcxErrorKind::AskarBusy => LibvcxErrorKind::AskarBusy,
            AriesVcxErrorKind::AskarCustom => LibvcxErrorKind::AskarCustom,
            AriesVcxErrorKind::AskarDuplicate => LibvcxErrorKind::AskarDuplicate,
            AriesVcxErrorKind::AskarEncryption => LibvcxErrorKind::AskarEncryption,
            AriesVcxErrorKind::AskarInput => LibvcxErrorKind::AskarInput,
            AriesVcxErrorKind::AskarNotFound => LibvcxErrorKind::AskarNotFound,
            AriesVcxErrorKind::AskarUnexpected => LibvcxErrorKind::AskarUnexpected,
            AriesVcxErrorKind::AskarUnsupported => LibvcxErrorKind::AskarUnsupported,
